...
alt.base.color=${colors.surface_container_low}
button.color=${colors.primary_container}
light.color=${colors.surface_container_low}
mid.light.color=${colors.surface_container_high}
dark.color=${colors.surface_container_high}
mid.color=${colors.surface_container_high}
highlight.color=${colors.primary}
inactive.highlight.color=${colors.primary}
text.color=${colors.on_background}
window.text.color=${colors.on_background}
button.text.color=${colors.on_primary_container}
disabled.text.color=#898d99
tooltip.text.color=${colors.on_background}
highlight.text.color=${colors.on_primary_container}
link.color=${colors.secondary}
link.visited.color=${colors.tertiary}
